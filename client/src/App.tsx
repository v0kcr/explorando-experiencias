...
function Layout({ children }: { children: ReactNode }) {
  ...
  return <div className="app-shell">
    <div className="announcement"><div className="container announcement-inner"><span>✦ Vive Perú de una forma distinta</span><span>Diseñamos momentos que se quedan.</span><a href="https://wa.me/51999999999" target="_blank" rel="noreferrer">Escríbenos por WhatsApp <ArrowRight size={13} /></a></div></div>
...
function HomePage() {
  return <Layout><main>
    <section className="home-hero"><div className="hero-backdrop" /><div className="container hero-content"><div className="hero-copy"><span className="eyebrow light">Viajes · Eventos · Comunidad</span><h1>El mundo se ve<br /><em>mejor acompañado.</em></h1><p>Diseñamos experiencias que despiertan tus sentidos, conectan personas y convierten cada destino en una historia para contar.</p><div className="hero-actions"><ButtonLink href="/servicios/viajes-solteros">Reserva tu experiencia</ButtonLink><Link className="play-link" href="/quienes-somos"><span className="play-circle"><Play size={14} fill="currentColor" /></span> Conoce nuestra historia</Link></div></div><div className="hero-stamp"><span>PERÚ</span><b>↗</b><small>Experiencias<br />con intención</small></div></div><div className="hero-bottom container"><span>Explorando Experiencias · Lima / Perú</span><span>Scroll para descubrir <ArrowRight size={14} /></span></div></section>
